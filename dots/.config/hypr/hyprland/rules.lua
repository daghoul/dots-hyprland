...
hl.window_rule({ match = { class = "^(org.kde.ark)$" }, size = {"(monitor_w*0.45)", "(monitor_h*0.45)"} })
...
hl.window_rule({ match = { class = "org.freedesktop.impl.portal.desktop.kde" }, center = true })
hl.window_rule({
